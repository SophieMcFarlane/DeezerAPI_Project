...
public class MainActivity extends AppCompatActivity implements Results, OnResultSelectedInterface, OnPlaylistResultSelectedInterface, OnArtistResultSelectedInterface, OnTrackResultsSelectedInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button searchAlbum = findViewById(R.id.btn_searchAlbum);
        final Button searchTrack = findViewById(R.id.btn_searchTrack);
        final Button searchArtist = findViewById(R.id.btn_searchArtist);
        final Button searchPlaylist = findViewById(R.id.btn_searchPlaylist);
